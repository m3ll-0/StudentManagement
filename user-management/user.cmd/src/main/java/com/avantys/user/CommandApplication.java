package com.avantys.user;

import com.avantys.cqrs.core.infrastructure.QueryDispatcher;
import com.avantys.user.api.commands.*;
import com.avantys.cqrs.core.infrastructure.CommandDispatcher;
import com.avantys.user.api.queries.FindAllStudentsQuery;
import com.avantys.user.api.queries.FindStudentByIdQuery;
import com.avantys.user.api.queries.QueryHandler;
